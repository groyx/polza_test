"""
Задача 1, шаг 1: сбор компаний с сигналом спроса.

Логика выбора источника. Продукт Polza — холодные рассылки, которые приводят
...
# Polza сейчас работает по промышленному оборудованию. База под них должна
